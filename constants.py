...
class Conversion(object):
    ...
    '''
    # Make division by zero a warning
    ...
    def __call__(self, othernum):
        try:
            ...
            try:
                ...
                return self.num / float(othernum)
...
CM2ANGSTROM   = Conversion(1E8)
M2NM          = Conversion(1E9)
M2CM          = Conversion(100)
CM2M          = Conversion(1 / M2CM)
ANGSTROM2M    = Conversion(1 / M2ANGSTROM)
ANGSTROM2CM   = Conversion(1 / CM2ANGSTROM)
NM2M          = Conversion(1 / M2NM)
M2BOHR        = Conversion(M2ANGSTROM * ANGSTROM2BOHR)
BOHR2CM       = Conversion(BOHR2ANGSTROM * ANGSTROM2M * M2CM)
BOHR2M        = Conversion(1 / M2BOHR)
...
HART2JOULE    = Conversion(4.35974394E-18)
...
DEBYE2AU = Conversion(1 / AU2DEBYE)

#HART2JOULE = 4.35974394E-18
#JOULE2HART = 1 / 4.35974394E-18


# Setup the 3D-Levi-Civita Tensor
LEVICIVITA3          = zeros( (3,3,3) )
LEVICIVITA3[0][1][2] =  1
LEVICIVITA3[1][2][0] =  1
LEVICIVITA3[2][0][1] =  1
LEVICIVITA3[0][2][1] = -1
...
# Setup the 3D-Kronecker Delta
KRONECKER3           = zeros ( (3,3) )
KRONECKER3[0][0]     = 1
KRONECKER3[1][1]     = 1
KRONECKER3[2][2]     = 1
...
# Change Zi to Zn for Zinc. -- Pengchong Liu, Aug. 2016
...
def atomic_radius(element, set='vis'):
